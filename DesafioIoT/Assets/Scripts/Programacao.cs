...
public class Programacao : MonoBehaviour {
    ...
    public GameObject disN1_0, okN1_0, erroN1_0, disN1_1, okN1_1, erroN1_1, disN2_0, okN2_0, erroN2_0, disN2_1, okN2_1, erroN2_1;
    public GameObject disN2_2, okN2_2, erroN2_2, disN3_0, okN3_0, erroN3_0, disN3_1, okN3_1, erroN3_1, disN3_2, okN3_2, erroN3_2;
    public GameObject disN4_0, okN4_0, erroN4_0, disN4_1, okN4_1, erroN4_1, disN4_2, okN4_2, erroN4_2, disN4_3, okN4_3, erroN4_3, disN5, okN5, erroN5;
    ...
    public void Awake()
    {
        ...
        disN1_0.SetActive(true); okN1_0.SetActive(false); erroN1_0.SetActive(false); disN1_1.SetActive(true); okN1_1.SetActive(false); erroN1_1.SetActive(false); disN2_0.SetActive(true); okN2_0.SetActive(false); erroN2_0.SetActive(false); disN2_1.SetActive(true); okN2_1.SetActive(false); erroN2_1.SetActive(false);
        disN2_2.SetActive(true); okN2_2.SetActive(false); erroN2_2.SetActive(false); disN3_0.SetActive(true); okN3_0.SetActive(false); erroN3_0.SetActive(false); disN3_1.SetActive(true); okN3_1.SetActive(false); erroN3_1.SetActive(false); disN3_2.SetActive(true); okN3_2.SetActive(false); erroN3_2.SetActive(false);
        disN4_0.SetActive(true); okN4_0.SetActive(false); erroN4_0.SetActive(false); disN4_1.SetActive(true); okN4_1.SetActive(false); erroN4_1.SetActive(false); disN4_2.SetActive(true); okN4_2.SetActive(false); erroN4_2.SetActive(false); disN4_3.SetActive(true); okN4_3.SetActive(false); erroN4_3.SetActive(false); disN5.SetActive(true); okN5.SetActive(false); erroN5.SetActive(false);
        textoOut.GetComponent<Text>().color = Color.red;
    ...
    private void missaoConcluida() {
        ...
        if (countFinal != 12)
        {
            textoOut.GetComponent<Text>().color = Color.green;
                    ...
                    if (code == "sensorChuva")
                    {
                        ...
                        if (code == "valChuva")
                        {
                            ...
                            if (code == "600")
                            {
                                ...
                                N1_1.SetActive(true);
                                erroN1_0.SetActive(false);
                                okN1_0.SetActive(true);
                            }
                            else
                            {
                    ...
                    if (code == "valChuva")
                    {
                        ...
                        if (code == "motorSet_rot(1);")
                        {
                            ...
                            if (code == "5")
                            {
                                ...
                                tileN1_1.SetActive(false);
                                N1_1.SetActive(false);
                                erroN1_1.SetActive(false);
                                okN1_1.SetActive(true);
                            }
                            else
                            {
                                textoOut.GetComponent<Text>().text = "A entrada 5 está errada";
                    ...
                    if (code == "sensorUmd")
                    {
                        ...
                        if (code == "bthPub")
                        {
                            ...
                            if (code == "pdMS_TO_TICKS(1000)")
                            {
                                ...
                                erroN2_0.SetActive(false);
                                okN2_0.SetActive(true);
                    ...
                    if (code == "xTaskCreate")
                    {
                        ...
                        if (code == "xTaskCreate")
                        {
                            ...
                            if (code == "512")
                            {
                                ...
                                tileN2_1.SetActive(false);
                                N2_1.SetActive(false);
                                erroN2_1.SetActive(false);
                                okN2_1.SetActive(true);
                    ...
                    if (code == "70")
                    {
                        ...
                        if (code == "irrigSet_state")
                        {
                            ...
                            if (code == "irrigSet_state")
                            {
                                ...
                                tileN2_2.SetActive(false);
                                N2_2.SetActive(false);
                                erroN2_2.SetActive(false);
                                okN2_2.SetActive(true);
                            }
                            else
                            {
                                textoOut.GetComponent<Text>().text = "A entrada 5 está errada";
                    ...
                    if (code == "sensorCor")
                    {
                        ...
                        if (code == "sensorCor_meas();")
                        {
                            ...
                            if (code == "bthPub_val")
                            {
                                ...
                                erroN3_0.SetActive(false);
                                okN3_0.SetActive(true);
        ...
        if (Missao.instance.getObs() == 7)
        {
            ...
            if (code == "valTemp")
            {
                ...
                if (code == "sensorTempUmd_init();")
                {
                    ...
                    if (code == "configMINIMAL_STACK_SIZE")
                    {
                        ...
                        if (code == "sensorTempUmd_measTemp();")
                        {
                            ...
                            if (code == "sensorTempUmd_measUmd();")
                            {
                                ...
                                tileN3_1.SetActive(false);
                                N3_1.SetActive(false);
                                erroN3_1.SetActive(false);
                                okN3_1.SetActive(true);
                    ...
                    if (code == "0")
                    {
                        ...
                        if (code == "releSet_state")
                        {
                            ...
                            if (code == "0")
                            {
                                ...
                                tileN3_2.SetActive(false);
                                N3_2.SetActive(false);
                                erroN3_2.SetActive(false);
                                okN3_2.SetActive(true);
                            }
                            else
                            {
                                textoOut.GetComponent<Text>().text = "A entrada 5 está errada";
                    ...
                    if (code == "RTC_init();")
                    {
                        ...
                        if (code == "2")
                        {
                            ...
                            if (code == "120")
                            {
                                ...
                                erroN4_0.SetActive(false);
                                okN4_0.SetActive(true);
                    ...
                    if (code == "3")
                    {
                        ...
                        if (code == "1")
                        {
                            ...
                            if (code == "300")
                            {
                                ...
                                tileN4_1.SetActive(false);
                                N4_1.SetActive(false);
                                erroN4_1.SetActive(false);
                                okN4_1.SetActive(true);
                    ...
                    if (code == "buzzerSet_state")
                    {
                        ...
                        if (code == "1")
                        {
                            ...
                            if (code == "300")
                            {
                                ...
                                tileN4_2.SetActive(false);
                                N4_2.SetActive(false);
                                erroN4_2.SetActive(false);
                                okN4_2.SetActive(true);
                ...
                if (code == "blePub_val")
                {
                    ...
                    if (code == "blePub_val")
                    {
                        ...
                        if (code == "blePub_val")
                        {
                            ...
                            tileN4_3.SetActive(false);
                            N4_3.SetActive(false);
                            erroN4_3.SetActive(false);
                            okN4_3.SetActive(true);
                        }
                        else
                        {
                            textoOut.GetComponent<Text>().text = "A entrada 4 está errada";
    ...
    public void setError(int testIdMiss)
    {
        Debug.Log(testIdMiss);
        
        if (testIdMiss == 1) {
            
            disN1_0.SetActive(false);
            erroN1_0.SetActive(true);
        }
        else if(testIdMiss == 2) {
            disN1_1.SetActive(false);
            erroN1_1.SetActive(true);
        }
        else if (testIdMiss == 3)
        {
            disN2_0.SetActive(false);
            erroN2_0.SetActive(true);
        }
        else if (testIdMiss == 4)
        {
            disN2_1.SetActive(false);
            erroN2_1.SetActive(true);
        }
        else if (testIdMiss == 5)
        {
            disN2_2.SetActive(false);
            erroN2_2.SetActive(true);
        }
        else if (testIdMiss == 6)
        {
            disN3_0.SetActive(false);
            erroN3_0.SetActive(true);
        }
        else if (testIdMiss == 7)
        {
            disN3_1.SetActive(false);
            erroN3_1.SetActive(true);
        }
        else if (testIdMiss == 8)
        {
            disN3_2.SetActive(false);
            erroN3_2.SetActive(true);
        }
        else if (testIdMiss == 9)
        {
            disN4_0.SetActive(false);
            erroN4_0.SetActive(true);
        }
        else if (testIdMiss == 10)
        {
            disN4_1.SetActive(false);
            erroN4_1.SetActive(true);
        }
        else if (testIdMiss == 11)
        {
            disN4_2.SetActive(false);
            erroN4_2.SetActive(true);
        }
        else if (testIdMiss == 12)
        {
            disN4_3.SetActive(false);
            erroN4_3.SetActive(true);
        }
        else if (testIdMiss == 13)
        {
            disN5.SetActive(false);
            erroN5.SetActive(true);
        }
    }
